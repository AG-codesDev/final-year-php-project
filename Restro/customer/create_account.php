        ...
        <div class="container mt--8 pb-5">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                    ...
                    <span class="card-heading">Enter your details below:</span>
                            ...
                            <form method="post" role="form">
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="shadow-lg" required name="customer_name" placeholder="Full Name" type="text">
                                        <input class="shadow-lg" value="<?php echo $cus_id;?>" required name="customer_id"  type="hidden">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="shadow-lg" required name="customer_phoneno" placeholder="Phone Number" type="text">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="" required name="customer_email" placeholder="Email" type="email">
                                    </div>
                                </div>
