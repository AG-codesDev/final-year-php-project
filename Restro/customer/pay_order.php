          ...
          <div class="card shadow">
            ...
            <div class="card-body bg-dark">
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  <div class="col-md-6">
                    <label class="text-secondary">Payment ID</label>
                    <input type="text" name="pay_id" readonly value="<?php echo $payid;?>" class="form-control bg-dark text-light">
                  </div>
                  <div class="col-md-6">
                    <label class="text-secondary">Payment Code</label><small class="text-danger"> ( Type 10 Digits Alpha-Code If Payment Method Is In Cash )</small>
                    <input type="text" limit="11" name="pay_code" placeholder="<?php echo $mpesaCode; ?>" class="form-control bg-dark text-light" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="pay_amt" readonly value="<?php echo $total;?>" class="form-control bg-dark text-light">
                  </div>
                  <div class="col-md-6">
                    <label class="text-secondary">Payment Method</label>
                    <select class="form-control bg-dark text-light" name="pay_method">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="pay" value="Pay Order" class="btn btn-danger" value="">
                  </div>
                </div>
              </form>
            </div>
