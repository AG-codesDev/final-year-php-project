                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        ?>
                                            <input class="form-control bg-dark text-light" readonly name="customer_name" value="<?php echo $cust->customer_name; ?>">
                                        <?php } ?>
                                        <input type="hidden" name="order_id" value="<?php echo $orderid; ?>" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Order Code</label>
                                        <input type="text" readonly name="order_code" value="<?php echo $alpha; ?>-<?php echo $beta; ?>" class="form-control bg-dark text-light" value="">
                                    </div>
                                </div>
                                <hr>
                                <?php
