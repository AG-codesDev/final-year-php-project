              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="staff_number" class="form-control text-light bg-dark" value="<?php echo $alpha; ?>-<?php echo $beta; ?>">
                  </div>
                  <div class="col-md-6">
                    <label class="text-secondary">Staff Name</label>
                    <input type="text" name="staff_name" class="form-control text-light bg-dark" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="email" name="staff_email" class="form-control text-light bg-dark" value="">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addStaff" value="Add Staff" class="btn btn-danger" value="">
                  </div>
                </div>
              </form>
            </div>
