              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="customer_name" class="form-control bg-dark text-secondary">
                    <input type="hidden" name="customer_id" value="<?php echo $cus_id; ?>" class="form-control bg-dark text-secondary">
                  </div>
                  <div class="col-md-6">
                    <label class="text-secondary">Customer Phone Number</label>
                    <input type="text" name="customer_phoneno" class="form-control bg-dark text-secondary" value="">
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="email" name="customer_email" class="form-control bg-dark text-secondary" value="">
                  </div>
                  <div class="col-md-6">
                    <label class="text-secondary">Customer Password</label>
                    <input type="password" name="customer_password" class="form-control bg-dark text-secondary" value="">
                  </div>
                </div>
                <br>
                <div class="form-row">
