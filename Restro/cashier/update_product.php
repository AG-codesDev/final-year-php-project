                ...
                <form method="POST" enctype="multipart/form-data">
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="text" value="<?php echo $prod->prod_name; ?>" name="prod_name" class="form-control bg-dark">
                    </div>
                    <div class="col-md-6">
                      <label class="text-secondary">Product Code</label>
                      <input type="text" name="prod_code" value="<?php echo $prod->prod_code; ?>" class="form-control bg-dark" value="">
                    </div>
                  </div>
                  <hr>
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="file" name="prod_img" class="btn btn-outline-success form-control bg-dark" value="<?php echo $prod_img; ?>">
                    </div>
                    <div class="col-md-6">
                      <label class="text-secondary">Product Price</label>
                      <input type="text" name="prod_price" class="form-control bg-dark" value="<?php echo $prod->prod_price; ?>">
                    </div>
                  </div>
                  <hr>
                  <div class="form-row">
                    <div class="col-md-12">
                      ...
                      <textarea rows="5" name="prod_desc" class="form-control bg-dark" value=""><?php echo $prod->prod_desc; ?></textarea>
                    </div>
                  </div>
                  <br>
                  <div class="form-row">
