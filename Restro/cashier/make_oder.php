              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-4">
                    ...
                    <select class="form-control bg-dark" name="customer_name" id="custName" onChange="getCustomer(this.value)">
                    ...
                    <input type="hidden" name="order_id" value="<?php echo $orderid; ?>" class="form-control bg-dark">
                  </div>

                  <div class="col-md-4">
                    <label>Customer ID</label>
                    <input type="text" name="customer_id" readonly id="customerID" class="form-control bg-dark">
                  </div>

                  <div class="col-md-4">
                    <label>Order Code</label>
                    <input type="text" name="order_code" value="<?php echo $alpha; ?>-<?php echo $beta; ?>" class="form-control bg-dark" value="">
                  </div>
                </div>
                <hr>
                <?php
                ...
                ?>
                  <div class="form-row">
                    <div class="col-md-6">
                      ...
                      <input type="text" readonly name="prod_price" value="$ <?php echo $prod->prod_price; ?>" class="form-control bg-dark">
                    </div>
                    <div class="col-md-6">
                      <label>Product Quantity</label>
                      <input type="text" name="prod_qty" class="form-control bg-dark" value="">
                    </div>
                  </div>
                <?php } ?>
                <br>
